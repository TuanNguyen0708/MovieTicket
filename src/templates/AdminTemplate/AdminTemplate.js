...
const AdminTemplate = (props) => { //path, exact, Component
    ...
    const operations = <Fragment>
        ...
        }}> <div style={{ width: 50, height: 50, display: 'flex', justifyContent: 'center', alignItems: 'center', marginRight:'20px' }} className="text-2xl ml-5 rounded-full bg-red-200">{userLogin.taiKhoan.substr(0, 1)}</div></button> <button onClick={() => {
